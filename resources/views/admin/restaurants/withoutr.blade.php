        ...
        <form action="{{ route('admin.register.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror"
                    ...
                    value="{{ old('name') }}" required min="3" max="255">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="vat" id="vat" class="form-control @error('vat') is-invalid @enderror" required
                    placeholder="Inserisci la Tua Partita IVA" aria-describedby="vatHelper" value="{{ old('vat') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="address" id="address" class="form-control @error('address') is-invalid @enderror"
                    placeholder="Inserisci il Tuo Indirizzo" aria-describedby="addressHelper" value="{{ old('address') }}"
            ...
            <div class="mb-3">
                ...
                <input type="text" name="website" id="website" class="form-control @error('website') is-invalid @enderror"
                    placeholder="Inserisci il Tuo Sito" aria-describedby="websiteHelper" value="{{ old('website') }}">
            ...
            <div class="mb-3">
                ...
                <input type="tel" name="phone" id="phone" class="form-control @error('phone') is-invalid @enderror" min="8"
                    max="20" placeholder="Inserisci un recapito telefonico" aria-describedby="phoneHelper"
                    value="{{ old('phone') }}">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('description') is-invalid @enderror" name="description"
                    ...
                    placeholder="Inserisci la descrizione del Tuo Ristorante">{{ old('description') }}</textarea>
                @error('description')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>

            <p class="text-capitalize">campi obbligatori</p>
