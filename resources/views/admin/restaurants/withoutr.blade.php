...
@section('content')
    <div class="container mt-5 pt-5">
        <div class="row justify-content-center m-5">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Crea un nuovo ristorante</div>
                    <div class="card-body">
                        <form action="{{ route('admin.register.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" name="restaurant_image" id="restaurant_image" accept="image/*"
                                    placeholder="https://" aria-describedby="restaurant_imageHelper"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="vat" id="vat"
                                    ...
                                    placeholder="Partita IVA ristorante ..." aria-describedby="vatHelper"
                                    value="{{ old('vat') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="tel" name="phone" id="phone"
                                    class="form-control @error('phone') is-invalid @enderror" min="8" max="20"
